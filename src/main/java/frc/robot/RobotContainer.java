...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    FightStick.fightStickX.whenPressed(
        new ShootBalls(
            climb, drivetrain, indexer, intake, outtake, portal, limelight, shooterDataTable));
    ...
    FightStick.fightStickLT.whenActive(
        new ShootLowGoal(climb, drivetrain, indexer, intake, outtake, portal));
    ...
    xboxSquares.whenPressed(
        new FunctionalCommand( // Toggle drive mode
            () -> {
    ...
    xboxRP.whenPressed(
        new FunctionalCommand(
            drivetrain::shiftUp, () -> {}, interrupted -> {}, () -> true, drivetrain)); // Shift up
  }
  ...
  public void configureDefaultCommands() {
    ...
    outtake.setDefaultCommand(
        new AlwaysTurretTurnToGoalWithLimelightAndSetHoodAngleOrManualControl(
            limelight, outtake, shooterDataTable)); // Check fight stick y-axis for
  }
