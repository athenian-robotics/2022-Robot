package frc.robot.commands.auto.AutoRoutine1Contents;
...
public class AutoRoutine1Part225 extends CommandBase {
    private final RamseteCommand ramseteCommand;
    private final DrivetrainSubsystem drivetrain;
    private final PathPlannerTrajectory trajectory;

    public AutoRoutine1Part225(DrivetrainSubsystem drivetrainSubsystem) {
        ...
        PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("Auto Routine 1 Part 2.25", Constants.AutoConstants.maxAutoSpeed, Constants.AutoConstants.maxAutoAcceleration);
