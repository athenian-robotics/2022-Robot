...
public class AutoRoutine1Part3 extends CommandBase {
    private final RamseteCommand ramseteCommand;
    private final DrivetrainSubsystem drivetrain;
    private final PathPlannerTrajectory trajectory;

    public AutoRoutine1Part3(DrivetrainSubsystem drivetrainSubsystem) {
        ...
        PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("Auto Routine 1 Part 3", Constants.AutoConstants.maxAutoSpeed, Constants.AutoConstants.maxAutoAcceleration);
