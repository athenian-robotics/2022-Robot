...
public class AutoRoutine1Part4 extends CommandBase {
    ...
    public AutoRoutine1Part4(DrivetrainSubsystem drivetrainSubsystem) {
        ...
        PathPlannerTrajectory exampleTrajectory = PathPlanner.loadPath("Auto Routine 1 Part 4", Constants.AutoConstants.maxAutoSpeed, Constants.AutoConstants.maxAutoAcceleration);
