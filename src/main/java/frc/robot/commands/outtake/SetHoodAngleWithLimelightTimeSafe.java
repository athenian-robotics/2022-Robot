...
public class SetHoodAngleWithLimelightTimeSafe extends SequentialCommandGroup {
    public SetHoodAngleWithLimelightTimeSafe(ShooterDataTable shooterDataTable, LimelightSubsystem limelightSubsystem
        ...
        ); //We have to take the L with this calculation and assume that the hood angle starts at the default instead
        // of taking a measurement
    }
}