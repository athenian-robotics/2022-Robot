    ...
    addCommands(
        ...
        new ParallelDeadlineGroup(
            new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                    new GuaranteeLimelightData(limelight), new ManualAdjustTurret(outtake)),
                ...
                new ParallelDeadlineGroup(
                    new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                            ...
                            new SetHoodAngleWithLimelightTimeSafe(
                                shooterDataTable, limelight, outtake)),
                        // Shoot Balls
                    ...
                    new AlwaysTurretTurnToGoalWithLimelightAndSetHoodAngleOrManualControl(
                        limelight, outtake, shooterDataTable)),
                // Return to teleop
