...
public class OuttakeSubsystem extends SubsystemBase {
    ...
    public void setHoodAngle(double angle) { if (angle<=45.0 && angle>=9.0) { leftHoodAngleServo.setPosition(140*(angle-8)/37.0); rightHoodAngleServo.setPosition(140*(angle-8)/37.0); }}

    public double getHoodAngle() { return (37*(leftHoodAngleServo.getPosition() + rightHoodAngleServo.getPosition())/280) + 8; } //DEGREES + DEFAULT 9
