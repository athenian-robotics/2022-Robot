...
public class PortalSubsystem extends SubsystemBase {
    private final CANSparkMax portalMotor = new CANSparkMax(intakeToIndexerMotorPort, CANSparkMaxLowLevel.MotorType.kBrushless);
    ...
    public boolean allianceBallPrimed() {return ballPrimed() && primedBallColor() == RobotContainer.alliance && RobotContainer.alliance != DriverStation.Alliance.Invalid;}
